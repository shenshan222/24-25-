...
namespace {
struct qt_meta_tag_ZN10InfoDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10InfoDialogE = QtMocHelpers::stringData(
    "InfoDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10InfoDialogE[] = {
...
Q_CONSTINIT const QMetaObject InfoDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10InfoDialogE.offsetsAndSizes,
    qt_meta_data_ZN10InfoDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10InfoDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *InfoDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10InfoDialogE.stringdata0))
